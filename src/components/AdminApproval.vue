...
export default {
  ...
  ,
  components : {
    adminSearchUser : require('components/admin_approval/AdminSearchUser.vue').default,
    adminSearchResults : require ('components/admin_approval/AdminSearchResults.vue').default,
