        ...
        >
          <q-tab name="basic" icon="fas fa-user-cog" label="Basic" >
                    <q-badge v-if="basicHasError" align="top" color="blue" floating>
                        Error <q-icon name="warning" color="yellow" class="q-ml-sm" />
                    </q-badge>
          </q-tab>
        ...
        animated>
          ...
          <q-tab-panel name="personal">
            ...
            <q-form greedy ref="personalForm">
              <div class="row">
                 ...
                 <div class="row">
                 <div class="col">
                   <q-select v-model="formData.gotra"
                    outlined
                    dense
                     options-dense
                  ...
                  <div class="col">
                   <q-input v-model="formData.originalSurname"
                    outlined
                    dense
                 ...
                 <q-input outlined v-model="formData.residentialAddress"
          ...
          <q-tab-panel name="upload">
              ...
              <q-form ref="uploadForm" greedy>
                   ...
                   <q-field
                   borderless
                   :rules="[ val => !!val || 'One Photo is required']"
                   dense
                   >
                  <template v-slot:control>
                   ...
                   <q-field
                   borderless
                   :rules="[ val => !!val || 'One ID Proof is required']"
                   dense
                   >
                  <template v-slot:control>
                    <q-uploader
              ...
              <q-select v-model="formData.sourceOfWebsite" :options="sourceOfWebsiteOptions"
             ...
             <div class="row">
              ...
              <q-btn color="secondary" label="Back"
              flat
              @click="tab = 'personal'"/>
              <q-space/>
...
martialOptions : ['Never Married','Divorced','Widowed','Awaiting Divorce'],
countryOptions : countryList,
heightOptions : [],
ageFromToOptions : [],
gotraOptions : gotraList,
sourceOfWebsiteOptions : ['Friends','Families','FaceBook','WhatsApp','Other'],
...
let heightFromInches = heightFrom.substr(5,2); // 5 is position for inches
